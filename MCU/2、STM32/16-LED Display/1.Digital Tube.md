...
## 2、<span style="color:brown">控制问题：</span>
...
**单片机的`Pin`输出`Current`**约`1 mA`，一般采用**三极管电路**来增加`IO`的驱动能力。因此可行的逻辑电路，如下：

<img src="https://raw.githubusercontent.com/root-bine/image/main/Typora-image/Digital_Tube03.png" alt="image-20251101144005078" style="zoom:35%;" />

上述布局可以集成到芯片`74HC245`，来**增加单片机引脚的驱动能力**：
