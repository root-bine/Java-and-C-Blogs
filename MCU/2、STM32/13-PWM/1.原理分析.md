...
<img src="https://raw.githubusercontent.com/root-bine/image/main/Typora-image/PWM01.png" alt="image-20251012124949747" style="zoom:40%;" />

| 占空比（`Duty Cycle`，`D`） | `D = Ton / T` | 通常用百分比表示（`0% ~ 100%`） |
| :-------------------------: | :-----------: | :-----------------------------: |

<img src="https://raw.githubusercontent.com/root-bine/image/main/Typora-image/PWM02.png" alt="image-20251012125126878" style="zoom:40%;" />
...
> 参考芯片手册章节：<span style="color:red">定时器复用功能重映射</span>  

<img src="https://raw.githubusercontent.com/root-bine/image/main/Typora-image/STM32_PWM_03.png" alt="image-20251204152343453" style="zoom:45%;" />

✅所有**可用于 PWM 的引脚**必须是**Timer的CH1/CH2/CH3/CH4所在引脚**。
